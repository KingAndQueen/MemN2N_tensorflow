...
flags.DEFINE_float("max_grad_norm", 5, "clip gradients to this norm [50]")
...
def main(_):
    ...
    train_data = read_data('%s/%s.train.txt' % (FLAGS.data_dir, FLAGS.data_name), count, word2idx,FLAGS)
    valid_data = read_data('%s/%s.valid.txt' % (FLAGS.data_dir, FLAGS.data_name), count, word2idx,FLAGS)
